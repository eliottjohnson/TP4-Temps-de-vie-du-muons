...
\begin{table}[htbp]
  \centering
  \caption{Temps de vie des muons positifs et négatifs dans différents matériaux. Le temps de vie des muons positifs est tout le temps 2.2 $\mu s$, alors que le temps de vie des muons négatifs dépends du nombre atomique Z \cite{tamamushi_lifetime_nodate}.}
  \scalebox{0.8}{
    \begin{tabular}{lccc}
